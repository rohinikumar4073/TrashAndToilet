...
public class AddNew extends android.support.v4.app.FragmentActivity {
	...
	public static void setReportingLatitude(double reportingLatitude) {
		AddNew.reportingLatitude = reportingLatitude;
	}
	...
	public static void setReportingLongitude(double reportingLongitude) {
		AddNew.reportingLongitude = reportingLongitude;
	}
	...
	public static void setReportingLocationType(String reportingLocationType) {
		AddNew.reportingLocationType = reportingLocationType;
	}
	...
	public static void setDescription(String description) {
		AddNew.description = description;
	}
